// MainContent: shows the main area of the page based on the selected tab
// - activeTab: which section to show (e.g., Home, Contact)
// - onTabChange: switch sections when needed (not used here directly)
const MainContent = ({ activeTab, onTabChange }) => {
  // A simple counter to demonstrate interactivity (increase/decrease/reset)
  const [counter, setCounter] = React.useState(0);

  // Content for each available tab in this section
  const tabs = [
  ...
  // Decide which tab content to show; default to the first tab if not found
        ...
        <div className="row">
          <div className="col-12">
            <div className="card">
              ...
              {/* CONTACT: simple info card with ways to reach us */}
              {activeTab === 'contact' && (
                <div className="row">
                  <div className="col-12">
